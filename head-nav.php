...
$whomWeServePages = array(
  ...
  // Use cases
  'usecase-school-transformation',
  'usecase-campus-employability',
...
$isWhomWeServeActive = in_array($page, $whomWeServePages);
?>
...
<!-- ================= WHOM WE SERVE ================= -->
<li class="nav-item dropdown static <?php echo $isWhomWeServeActive ? 'active' : ''; ?>">
<a class="nav-link dropdown-toggle <?php echo $isWhomWeServeActive ? 'active' : ''; ?>"
   href="#" data-toggle="dropdown">
<i class="fas fa-users mr-1"></i>Whom We Serve
</a>
...
<!-- COLUMN A : WHOM WE SERVE -->
<div class="col-lg-4 col-md-4 col-sm-12">
<h6 class="font-weight-bold">
<i class="fas fa-building mr-2"></i>Whom We Serve
</h6>
...
<div class="col-lg-4 col-md-4 col-sm-12">
<h6 class="font-weight-bold">
<i class="fas fa-cogs mr-2"></i>Use Cases
</h6>
...
<i class="fas fa-cogs mr-1"></i>Programs
</a>
...
<li class="nav-item dropdown"  style="position:relative;   <?php echo $isAboutUsActive ? 'active' : ''; ?>">
...
<a href="<?php echo $base_url; ?>/book-a-call.php"
  ...
  <i class="fas fa-calendar-check mr-1"></i> Book a Call
</a>
