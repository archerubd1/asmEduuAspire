        ...
        <div class="col-lg-12 mb-4 order-0">
          ...
          <nav aria-label="breadcrumb" class="d-flex justify-content-end">
            <ol class="breadcrumb breadcrumb-style1">
              ...
              <li class="breadcrumb-item active">Performance & Rewards</li>
            </ol>
          </nav>
          <!--/ Custom Breadcrumb -->

          <!-- Accordion for Instructor Performance & Rewards -->
          <div class="accordion mt-3" id="accordionExample">
            <div class="accordion-item">
              <h4 class="accordion-header" id="heading1">
                ...
                >
                  <i class="bx bx-trophy"></i> &nbsp;&nbsp; Your Performance & Rewards
                </button>
              </h4>
                      ...
                      <div class="card-body">
                        <div class="container mt-5">
                          ...
                          <div class="card p-3 mt-3">
                            <h4 class="text-center"><i class="bx bx-award"></i> &nbsp;&nbsp; My Performance & Achievements</h4>
                            <table class="table table-striped table-hover text-center">
                              <thead class="table-dark">
                                <tr>
                                  <th>Category</th>
                                  <th><i class="bx bx-task"></i> Activity</th>
                                  <th><i class="bx bx-star"></i> Points Earned</th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td>📝 Assessments</td>
                                  <td>Designed 5 Quizzes for "Machine Learning"</td>
                                  <td>180</td>
                                  <td>2024-03-01</td>
                                  <td>✅ Approved</td>
                                </tr>
